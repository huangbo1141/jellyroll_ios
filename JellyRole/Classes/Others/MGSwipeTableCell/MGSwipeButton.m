...
{
    return [self buttonWithTitle:title icon:nil backgroundColor:color textColor:textColor callback:callback];
}
...
{
    return [self buttonWithTitle:title icon:icon backgroundColor:color textColor:[UIColor clearColor] callback:nil];
}
...
+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color textColor:(UIColor *)textColor callback:(MGSwipeButtonCallback) callback
{
    return [self buttonWithTitle:title icon:icon backgroundColor:color textColor:textColor padding:10 callback:callback];
}

+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color textColor:(UIColor *)textColor padding:(NSInteger) padding callback:(MGSwipeButtonCallback) callback
{
    return [self buttonWithTitle:title icon:icon backgroundColor:color textColor:textColor insets:UIEdgeInsetsMake(0, padding, 0, padding) callback:callback];
}

+(instancetype) buttonWithTitle:(NSString *) title icon:(UIImage*) icon backgroundColor:(UIColor *) color textColor:(UIColor *)textColor insets:(UIEdgeInsets) insets callback:(MGSwipeButtonCallback) callback
{
